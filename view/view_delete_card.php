    ...
    <div id="container_delete">
        <div id="window_delete">
            <div id="delete_text">
                ...
                <form class='link' action='board/board/<?= $board ?>' method='post'>
                    <input type="hidden" name="id_card" value=<?= $_GET['param1'] ?>>
                    <input type="hidden" name="delete_card" value="oui">
                    <input id="bouton_form_delete" type='submit' value='Delete'>
                </form>

                <a id="bouton_form_delete_cancel" href="board/board/<?= $board ?>">Cancel</a>
            </div>
        </div>
    </div>
